...
# Rapport emails lifecycle Fusionn — 2026-05-30

Total envoyés : **50** · ouvertures enregistrées : **0**

| Séquence | Envoyés | Ouverts | Taux d'ouverture | Clics | Taux de clic |
|---|---|---|---|---|---|
| Activation (inscrit, 0 analyse) | 50 | 0 | 0 % | 0 | 0 % |
| Après 1 analyse | 0 | 0 | — | 0 | — |
| Après 2 analyses | 0 | 0 | — | 0 | — |
| Réengagement (inactif 14j) | 0 | 0 | — | 0 | — |
