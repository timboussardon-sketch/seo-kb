...
**How to apply** : à chaque invocation du skill `revue-presse-quotidienne`, lire d'abord 2 vraies éditions Substack dans `raw/articles/algorithme/algorithme-*.md` (PAS dans `raw/revue-de-presse/`) avant de rédiger. Si le sujet du jour exige plus de 5 acronymes pour être compris, choisir un autre sujet.
