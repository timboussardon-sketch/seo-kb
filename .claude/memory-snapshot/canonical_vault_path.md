...
description: The single source of truth for all SEO KB edits is /Users/timothee/Documents/seo-kb/ (Obsidian vault). Never edit copies elsewhere.
type: feedback
originSessionId: fcb3d870-d9e9-4689-ac81-bc37f188e359
---
Toujours éditer la SEO KB dans le vault Obsidian canonique : **`/Users/timothee/Documents/seo-kb/`** (présence d'un dossier `.obsidian` confirmée).
...
**How to apply:**
- Tous les edits de fichiers markdown SEO/GEO (briefs, concepts, entités, sources, syntheses, etc.) doivent cibler `/Users/timothee/Documents/seo-kb/`.
- Si une recherche `find` remonte plusieurs copies d'un même fichier ailleurs (Desktop, autres dossiers), **flagger la duplication** avant d'éditer — ne pas propager les edits sur des copies sans confirmation explicite.
...
1. **Quel vault Obsidian est ouvert** : `cat ~/Library/Application\ Support/obsidian/obsidian.json` — si le path n'est pas `/Users/timothee/Documents/seo-kb/`, c'est la cause. Tim doit "Open another vault" sur le bon path.
