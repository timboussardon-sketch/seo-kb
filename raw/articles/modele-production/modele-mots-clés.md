...
2. **Doctrine** scindée en deux pour éviter le doublon excerpt/body sur fusionn.co :
   - **Excerpt** (champ `excerpt` dans `blog_posts`, affiché sous le H1) : phrase d'accroche templatée pixel-perfect depuis le keyword : « La règle est simple : ne pas refaire ce que les autres [X] ont déjà produit. » (par exemple « La règle est simple : ne pas refaire ce que les autres consultants SEO ont déjà produit. »)
   - **Body** (premier `<blockquote>` du content) : commence directement par « Tu identifies 3 à 5 mots-clés business sur lesquels tu as un différenciant... » et développe l'autorité thématique + micro-intentions + problématiques.
   Trois piliers obligatoires dans le body : 3 à 5 mots-clés business + autorité thématique + micro-intentions/problématiques client. Le quatrième pilier (critique du status quo « ne pas refaire... ») vit dans l'excerpt. Aucun ajout d'interprétation personnelle (sanctions Google, citations LLM, anti-IA writing) en dehors de ces piliers.
