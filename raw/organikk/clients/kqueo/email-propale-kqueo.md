...
slug: email-propale-kqueo
title: "KQUEO — email d'envoi de la proposition (draft, non envoyé)"
created: 2026-07-23
updated: 2026-07-24
statut: draft, à valider par Tim avant envoi
tags: [kqueo, propale, email, acquisition, organikk]
---

# Email de propale KQUEO

Dérivé du gabarit maître `_MODELE-email-propale.md`. Recalé le 24/07 sur l'offre finale (2 mois à 1 400 €, 3 mois de suivi, garantie +20 %) et sur les trois documents en ligne.
...
Brancher votre Search Console et la croiser avec vos ventes, pour répondre à la question que personne ne peut trancher aujourd'hui : quelles recherches vous amènent des commandes.

Rendre vos 1 800 avis notés 9,4/10 lisibles par Google sur vos 78 fiches produit. Aucune de celles que j'ai relevées ne porte le balisage qui le permet.

Faire que vos 24 articles santé mènent à des sélections de produits, construites avec les critères de votre ergonome.

Créer les pages qui manquent entre vos articles et vos fiches : profils d'acheteurs, comparaisons entre vos gammes, et la page showroom, la seule recherche où personne ne peut vous concurrencer.

Supprimer la reprise à la main de Notion vers Shopify.

Construire l'agent SEO de KQUEO sur votre data, avec lequel Clément produit, qui garde la rédaction.
...
Petite précision : si on travaille ensemble, c'est moi qui serai sur votre projet.
