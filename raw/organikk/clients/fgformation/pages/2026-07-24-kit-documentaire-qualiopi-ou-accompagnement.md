...
title: "Page FG Formation : Kit documentaire Qualiopi ou accompagnement (duel 4)"
...
| Poste | Kit documentaire | Accompagnement |
|---|---|---|
| Le contenu | Des trames à adapter | Un système de preuves construit sur votre activité |
| Le travail restant | L'essentiel : adapter, produire, dater | Fait avec vous, pendant la prestation |
| L'adaptation à votre cas | À votre charge | Le cœur de la prestation |
| Le test avant l'audit | Aucun | Audit blanc en général inclus |
| Le coût | Achat unique, le moins cher du marché | Prestation, la plus chère des deux |
| Le risque principal | Un dossier générique qui ne tient pas à l'audit | Payer pour un besoin que vous n'avez peut-être pas |
...
Vous découvrez le référentiel et vous ne sauriez pas dire ce que l'indicateur 11 attend de vous. Votre calendrier est contraint par des clients en attente de financement. Ou vous voulez que le dossier soit testé avant l'audit réel, pas découvert pendant. Un kit ne répond à aucun de ces trois besoins : il fournit la forme, le besoin porte sur le fond.

Pour situer votre cas, [décrivez votre situation](https://fgformation.fr/contact/) : si un kit et le guide de lecture suffisent, autant le savoir avant de payer une prestation.
...
- Arrêté du 6 juin 2019 relatif aux modalités d'audit associées au référentiel national qualité, version en vigueur, Légifrance : échantillonnage représentatif des actions, régime des non-conformités, audit de surveillance.
...
- **Aucun éditeur de kit nommé, aucun prix de kit cité** : règle FG. Le « moins cher du marché » est une position relative structurelle (achat unique vs prestation), pas un chiffre.
- **Ton mesuré sur les kits** : la section « ce qu'un bon kit apporte » crédite l'option comparée (règle comparatifs jamais accusateurs). Le risque décrit (dossier générique) est adossé au fait vérifié de l'échantillonnage, pas à un procès d'intention.
- **Claim « dossier rempli en une fois se repère à ses dates »** : constat praticien issu des audits blancs, formulé comme tel.
- **Verbatims** : « rester acteur », « kit clé en main » (P1/P2, calls anonymisés).
- **Maillage sortant** : page tarif, contact, duel 1 (à lier lors de l'intégration), page audit blanc du guide en option.
- **Duel suivant** : audit blanc seul ou accompagnement complet (n° 5).
