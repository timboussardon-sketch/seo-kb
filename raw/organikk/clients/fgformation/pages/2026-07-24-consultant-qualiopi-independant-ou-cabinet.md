...
title: "Page FG Formation : Consultant Qualiopi indépendant ou cabinet (duel 6)"
...
| Poste | Consultant indépendant | Cabinet d'accompagnement |
|---|---|---|
| Qui travaille sur votre dossier | La personne qui a vendu la prestation | Un ou plusieurs intervenants, selon l'organisation |
| La connaissance de votre dossier | Concentrée sur une personne | Répartie, portée par la méthode et les outils |
| La capacité | Bornée : un agenda d'une personne | Plusieurs dossiers et sites en parallèle |
| Si l'interlocuteur change | La prestation s'arrête ou se transmet mal | La structure remplace l'intervenant |
| Le périmètre type | Formateurs indépendants, OF à taille humaine | OF multi-sites, groupes, volumes importants |
| Le prix | Tarifs libres dans les deux cas : comparez à périmètre écrit égal | Tarifs libres dans les deux cas : comparez à périmètre écrit égal |
...
Par les preuves : des références vérifiables, des réponses précises aux cinq questions listées plus haut, et un périmètre écrit. La certification Qualiopi du prestataire lui-même, quand il est aussi organisme de formation, se vérifie sur son certificat : [le nôtre est publié](https://fgformation.fr/certificat-qualiopi-francois-gruel-consult/).
...
Les tarifs sont libres dans les deux formats et les écarts tiennent surtout au périmètre couvert. Comparez des devis à périmètre écrit égal : construction, audit blanc, surveillance incluse ou non.

---

**À propos de l'auteur.** François Gruel est consultant indépendant : il accompagne des formateurs indépendants et des organismes de formation dans leur certification Qualiopi, de la déclaration d'activité à l'audit de surveillance. Les situations citées viennent de rendez-vous et d'audits blancs menés par FG Formation, anonymisés.
...
- Arrêté du 6 juin 2019 relatif aux modalités d'audit associées au référentiel national qualité, version en vigueur, Légifrance : audit de surveillance entre le 14e et le 22e mois.
...
- **Ton mesuré sur les cabinets** : capacité et continuité créditées explicitement, aucun procès d'intention (pas de « travail délégué à des juniors ») ; le point de vigilance est formulé en question à poser, valable pour les deux formats, indépendant compris.
- **Juge et partie annoncé dès le chapô** (« écrite depuis ce côté-là du marché ») + section « quand le cabinet est le bon choix » qui exclut FG nommément.
- **Claim « aucun agrément d'accompagnateur »** : affirmation d'absence, cohérente avec le corpus réglementaire consulté (seuls les certificateurs sont réglementés, arrêté accréditation) ; reformulée en « aucun texte n'encadre les prestataires d'accompagnement ». À faire relire par François.
- **Verbatim** : « on repart de zéro » (P4, call anonymisé).
- **Maillage sortant** : choisir-bon-partenaire (la vieille page checklist devient satellite de ce duel en attendant sa refonte), laccompagnement-fg-formation, certificat, contact.
- **Dernier duel** : accompagnement à distance ou en présentiel (n° 7).
