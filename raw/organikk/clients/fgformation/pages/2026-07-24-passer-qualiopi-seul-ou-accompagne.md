...
title: "Page FG Formation : Passer Qualiopi seul ou accompagné (duel 1 de la série X ou Y)"
...
**Slug proposé :** `/passer-qualiopi-seul-ou-accompagne/`
**Title SEO :** Passer Qualiopi seul ou accompagné : comment choisir - FG Formation
**Méta description :** Aucun texte n'impose un accompagnement pour obtenir Qualiopi. Ce qui change vraiment entre les deux options : les preuves, le coût, l'audit de surveillance. Comparaison poste par poste.
...
Passer seul, c'est lire ces deux documents, construire votre système de preuves indicateur par indicateur, choisir un organisme certificateur accrédité, puis payer et passer l'audit. Rien dans cette liste ne nécessite un prestataire externe.
...
| Poste | En autonomie | Avec un accompagnement |
|---|---|---|
| Le référentiel à couvrir | 7 critères, 32 indicateurs | Les mêmes, sans exception |
| Qui construit le dossier de preuves | Vous, seul | Vous, avec un cadre et des modèles |
| L'audit de certification | Payant, auprès d'un certificateur accrédité | Identique, l'accompagnateur n'audite pas |
| Face à l'auditeur | Vous | Vous, la responsabilité ne se délègue pas |
...
Vous avez déjà un système qualité documenté, par exemple une autre certification ou des process écrits et datés. Vous avez du temps devant vous, sans client bloqué en attente d'un financement. L'administratif ne vous rebute pas. Dans cette situation, le guide de lecture et les textes suffisent, et un accompagnement complet ne vous apporterait pas grand-chose.

Dans ce cas, la seule dépense externe pertinente peut être un audit blanc sec, sans accompagnement autour, pour tester votre dossier avant l'audit réel. C'est le format le plus léger du marché et il suffit à un candidat déjà structuré.
...
### Un accompagnateur peut-il garantir l'obtention de Qualiopi ?

Non. La décision appartient au certificateur accrédité et à personne d'autre. Une promesse commerciale de certification garantie n'engage pas l'auditeur qui viendra contrôler vos preuves.

### Peut-on acheter un dossier Qualiopi tout fait ?

Des offres existent. Le problème : le référentiel audite vos processus sur votre activité réelle, et un dossier générique se repère à l'audit, au plus tard à la surveillance, quand vous êtes seul face à l'auditeur. La responsabilité de la conformité reste la vôtre dans tous les cas.

### Peut-on se faire accompagner uniquement pour l'audit de surveillance ?

Oui. C'est un format court : remise à niveau du dossier et audit blanc avant l'échéance. C'est l'option adaptée aux organismes déjà certifiés qui veulent sécuriser le passage sans payer un accompagnement complet. Voir notre [préparation à l'audit de surveillance](https://fgformation.fr/formation-audit-surveillance-qualiopi/).

### Combien coûte l'audit de certification ?

Il n'existe pas de barème public : les tarifs des certificateurs sont libres. Le devis dépend de votre chiffre d'affaires, de vos catégories d'actions et de votre nombre de sites, car ces variables fixent la durée d'audit prévue par l'arrêté du 6 juin 2019. Comparez plusieurs certificateurs avant de signer.
...
- Arrêté du 6 juin 2019 relatif aux modalités d'audit associées au référentiel national qualité, version en vigueur, Légifrance : durées d'audit, audit de surveillance entre le 14e et le 22e mois, régime des non-conformités mineures et majeures, certification délivrée pour trois ans.
- Guide de lecture du référentiel national qualité, ministère du Travail (V9 du 8 janvier 2024, version en vigueur à la date de consultation).

Les textes et le guide de lecture évoluent. Les informations de cette page sont exactes à la date indiquée.

---

## Notes de production (à retirer avant mise en ligne)

- **Chiffres écartés volontairement** : aucun tarif de certificateur (libres, non documentés centralement), aucun temps de préparation (non publié, dépend du dossier), aucun prix d'accompagnement en dur (renvoi vers la page tarif du site). Le seuil de rentabilité des calls (4 formations/an) reste non publié, conformément aux règles de rédaction.
- **Arrêté du 1er juillet 2025 vérifié** : il ne modifie que l'article 10 bis de l'arrêté du 6 juin 2019 (un report de « juin » à « septembre »), sans impact sur les durées, la surveillance ou les non-conformités citées ici.
- **V10 du guide de lecture attendue en 2026** : à sa parution, relire cette page (le paragraphe sur le guide de lecture est rédigé pour vieillir sans dommage).
- **Verbatims** : « rester acteur… », « on fait tout à la main, c'est lourd », « j'ai horreur de l'administratif » viennent des calls anonymisés (P1, P5, transverse). Aucun nom, aucune structure identifiable.
- **Transparence** : le chapô annonce que FG vend l'accompagnement, la page nomme deux cas où l'autonomie ou l'audit blanc sec sont le bon choix. C'est voulu (skill comparatif-neutre).
- **Maillage sortant** : page tarif, l'accompagnement FG, sommaire du contenu, préparation audit de surveillance. À l'intégration, ajouter les liens vers les prochains duels de la série au fur et à mesure de leur mise en ligne.
- **Duel suivant proposé** : consultant Qualiopi ou logiciel Qualiopi (n° 2 du plan de série).
