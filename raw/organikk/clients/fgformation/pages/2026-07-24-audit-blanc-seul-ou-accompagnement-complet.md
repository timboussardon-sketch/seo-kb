...
title: "Page FG Formation : Audit blanc seul ou accompagnement complet (duel 5)"
...
| Poste | Audit blanc seul | Accompagnement complet |
|---|---|---|
| Le point de départ | Un dossier déjà construit | Un dossier à construire ou à reconstruire |
| Le livrable | La liste des écarts à corriger | Le dossier prêt, testé en fin de parcours |
| Qui corrige les écarts | Vous, seul | Vous, avec le consultant |
| Le format | Intervention courte et bornée | Suivi étalé jusqu'à l'audit |
| Le coût | Le format le moins cher de l'aide humaine | La prestation la plus complète, donc la plus chère |
| Le bon profil | Certifié préparant sa surveillance, candidat structuré | Premier passage, certification perdue, audit raté |
...
## L'accompagnement complet : quand le dossier part de zéro ou de loin
...
### Un audit blanc est-il obligatoire avant l'audit de certification ?

Non. Aucun texte ne le prévoit. C'est une pratique de préparation, utile mais facultative.
...
Un intervenant qui connaît le référentiel et la pratique réelle des audits, et qui n'est pas votre certificateur. Le déroulé complet est décrit sur notre page [audit blanc Qualiopi](https://fgformation.fr/le-guide/audit-blanc-qualiopi/).

### Peut-on faire un audit blanc pour l'audit initial, pas seulement pour la surveillance ?

Oui. Le format est le même ; seul le périmètre change, l'audit initial couvrant le dossier complet dans les locaux, quand la surveillance se fait à distance dans la plupart des cas.

---

**À propos de l'auteur.** François Gruel accompagne des formateurs indépendants et des organismes de formation dans leur certification Qualiopi, et réalise des audits blancs avant audit initial et audit de surveillance. Les situations citées viennent de rendez-vous et d'audits blancs menés par FG Formation, anonymisés.
...
- Arrêté du 6 juin 2019 relatif aux modalités d'audit associées au référentiel national qualité, version en vigueur, Légifrance : audit de surveillance entre le 14e et le 22e mois, modalités sur site et à distance, régime des non-conformités.
...
- **Pas de cannibalisation avec `le-guide/audit-blanc-qualiopi/`** : la page existante garde le rôle « qu'est-ce qu'un audit blanc, comment ça se déroule » et reçoit deux liens ; ce duel traite uniquement la décision entre les deux formats.
- **Aucune durée d'audit blanc affirmée** (« format court » sans chiffre) : le format exact varie, rien de publié.
- **Verbatims** : « valider que tout soit carré », « repartir sur une bonne base », « pas besoin d'un jour par semaine pendant 12 mois » (P5), « on repart de zéro » (P4), calls anonymisés.
- **Honnêteté commerciale explicite** : la page recommande l'audit blanc seul pour les dossiers prêts et qualifie le format complet de survente dans ce cas. Position validée par l'angle « accompagnement qui rend autonome » du dossier client.
- **Maillage sortant** : le-guide/audit-blanc-qualiopi (2 liens), formation-audit-surveillance-qualiopi, page tarif, contact, duel 1 à lier à l'intégration.
- **Duel suivant** : consultant indépendant ou cabinet (n° 6).
