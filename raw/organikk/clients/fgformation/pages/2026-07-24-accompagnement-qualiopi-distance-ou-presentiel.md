...
title: "Page FG Formation : Accompagnement Qualiopi à distance ou en présentiel (duel 7)"
...
**Slug proposé :** `/accompagnement-qualiopi-a-distance-ou-presentiel/`
**Title SEO :** Accompagnement Qualiopi à distance ou en présentiel : que choisir - FG Formation
**Méta description :** Le contenu d'un accompagnement Qualiopi est le même à distance et sur place. L'audit, lui, a des règles : initial dans vos locaux, surveillance à distance. De quoi choisir en connaissance.
...
## Distance ou présentiel : la comparaison poste par poste

| Poste | Accompagnement à distance | Accompagnement en présentiel |
|---|---|---|
| Le contenu | Identique : référentiel, preuves, audit blanc | Identique : référentiel, preuves, audit blanc |
| Le rythme | Sessions courtes, rapprochées, faciles à caler | Journées ou demi-journées, plus espacées |
| Le travail sur documents | Partage d'écran, corrections en direct | Revue sur place, classeurs compris |
| Ce qui se voit | Vos fichiers, pas vos locaux | Locaux, affichages, organisation matérielle |
| Le coût | Sans frais de déplacement | Déplacements facturés ou intégrés au prix |
| La répétition de l'audit | Dans les conditions de la surveillance | Dans les conditions de l'audit initial |
...
## En présentiel : ce qui ne se voit que sur place
...
### Un accompagnement à distance est-il accepté par les certificateurs ?

La question ne se pose pas : le certificateur n'a pas à connaître, ni à valider, votre mode de préparation. Il contrôle vos preuves à l'audit, quelle que soit la façon dont elles ont été construites.

### L'audit initial peut-il se faire en visioconférence ?

Non, dans le cas général : la version en vigueur de l'arrêté du 6 juin 2019 prévoit que l'audit initial se déroule dans les locaux de l'organisme candidat.

### L'audit de surveillance peut-il se faire sur site ?

Oui, dans trois cas prévus par l'arrêté : signalements, risques identifiés, ou si vous le demandez vous-même. Par défaut, il se tient à distance.

### Peut-on mélanger les deux modalités dans un même accompagnement ?

Oui, et c'est souvent le meilleur découpage : cadrage et répétition de l'audit initial sur place, suivi courant et préparation de la surveillance à distance.

---

**À propos de l'auteur.** François Gruel accompagne des formateurs indépendants et des organismes de formation dans leur certification Qualiopi, de la déclaration d'activité à l'audit de surveillance. Les situations citées viennent de rendez-vous et d'audits blancs menés par FG Formation, anonymisés.
...
- Arrêté du 6 juin 2019 relatif aux modalités d'audit associées au référentiel national qualité, version en vigueur, Légifrance : audit initial dans les locaux du candidat, audit de surveillance à distance entre le 14e et le 22e mois sauf cas prévus, durées d'audit.
