...
title: "Page FG Formation : Formation Qualiopi ou accompagnement individuel (duel 3)"
...
| Poste | Formation Qualiopi | Accompagnement individuel |
|---|---|---|
| Le livrable | Une compétence : lire le référentiel, savoir prouver | Un dossier de preuves prêt pour l'audit |
| Qui fait le travail documentaire | Vous, après la formation | Vous, pendant, avec le consultant |
| Le format | Sessions à dates et durée définies | Suivi étalé jusqu'à l'audit |
| L'adaptation à votre cas | Exemples appliqués, cadre commun | Entièrement construit sur votre activité |
| Après la certification | Vous êtes autonome si vous appliquez | Autonomie selon la qualité du transfert |
| Pour qui | Un référent qui fera vivre le système | Une structure qui veut le résultat ET la méthode |
...
Non. Aucun format ne la garantit : la décision appartient au certificateur accrédité, sur la base des preuves contrôlées à l'audit.
...
**À propos de l'auteur.** François Gruel accompagne et forme des formateurs indépendants et des organismes de formation sur la certification Qualiopi, de la déclaration d'activité à l'audit de surveillance. Les situations citées viennent de rendez-vous et d'audits blancs menés par FG Formation, anonymisés.
...
- Arrêté du 6 juin 2019 relatif aux modalités d'audit associées au référentiel national qualité, version en vigueur, Légifrance : durées d'audit, régime des non-conformités.
- Article L6316-1 du code du travail (financeurs dont le concours rend la certification obligatoire), Légifrance.
...
- **Double juge et partie assumé** : FG vend les deux formats, annoncé dès le chapô. La page nomme le cas « formation seule » et le combo formation + audit blanc (moins cher que l'accompagnement complet) : c'est voulu.
- **Financement rédigé au conditionnel prudent** : prise en charge possible pour une action de formation d'un organisme certifié (L6316-1, référentiel de faits vérifiés du 20/07), renvoi systématique au financeur pour la décision. Aucun taux, aucun montant. La nature « conseil » de l'accompagnement est signalée sans affirmer une inéligibilité générale.
- **Certificat FG** : le lien vers `certificat-qualiopi-francois-gruel-consult/` sert de preuve E-E-A-T. Vérifier avec François que la page est à jour avant mise en ligne.
- **Verbatim** : « j'ai horreur de l'administratif » (transverse, calls anonymisés).
- **Maillage sortant** : formation-qualiopi-initial, parcours-formation-label-et-qualiopi, laccompagnement-fg-formation, sommaire, certificat, duel 1, contact.
- **Duel suivant** : kit documentaire ou accompagnement (n° 4).
