...
Pour t'aider à repérer les infos les + utiles :
...
Ce que ça change concrètement : l'utilisateur tape une phrase entière, une question à tiroirs, une intention complète. Il ne tape plus trois mots-clés. Le contenu construit uniquement autour d'une requête exacte va souffrir, parce que la requête exacte disparaît au profit du langage naturel.

Et le contrecoup est déjà chiffré. HubSpot estime avoir perdu 70 à 80 % de son trafic organique, Chegg annonce -49 %, DMG Media documente jusqu'à -89 % sur certaines requêtes. En juillet, l'Independent Publishers Alliance a déposé plainte auprès de l'autorité de la concurrence britannique. DuckDuckGo revendique +75 % d'installations depuis l'annonce de mai.

**Pourquoi ça compte :** si ta seule métrique de succès est le clic organique, tu vas regarder ton trafic fondre sans comprendre. Le travail ne disparaît pas, il se déplace. L'objectif n'est plus de ranker une page, c'est de devenir la source que Gemini cite dans sa réponse. Le SEO reste le socle, mais le livrable change de nature.
