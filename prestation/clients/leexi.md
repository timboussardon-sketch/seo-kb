...
À trancher : plus rien côté rangement (consolidation faite le 02/07, architecture canonique dans `leexi-seo/production/cocons/`). Restent les arbitrages client : faits de conformité publiables, CTA essai vs démo, mode de publication Strapi. **Gate livrable en attente (03/07)** : draft de réécriture quick wins 1-2-3 prêt (`reecriture-qw1-2-3-2026-07-03.md`), Tim doit choisir title A ou B par page + confirmer le périmètre ISO 27001 avant Strapi.
