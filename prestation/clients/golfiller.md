...
## Où on en est
Étape courante : 12 (set usage complet rédigé en HTML/CSS, 5 pages) — prêt à coller Shopify
Prochaine action : article à ~95% (gate PASS, table distance/vitesse intégrée depuis la data du site). Décision mise en ligne. Topping optionnel : distance COMPARÉE par modèle (launch monitor). Puis dupliquer le gabarit usage. En réserve : pages de marque, titres faible CTR.
